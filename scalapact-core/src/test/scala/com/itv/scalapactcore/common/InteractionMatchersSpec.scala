...
//        Map(
//          "$.body.name.aga" -> MatchingRule(Option("regex"), Option("\\w+"), None)
//        )
//      )
//
...
//
//
//    it("should be able to match nested xml bodies with rules") {
//
//      val expected =
//        <ns4:name><foo>bar</foo><aga>joe</aga></ns4:name>
//
//      val received =
//        <ns4:name><foo>bar</foo><aga>fred</aga></ns4:name>
//
//      val rules: Option[Map[String, MatchingRule]] = Option(
//        Map(
//          "$.body.name[0].aga[0]" -> MatchingRule(Option("regex"), Option("\\D+"), None)
//        )
//      )
//
//      withClue("Didn't match json body with rule") {
//        matchBodies(rules)(expected.toString())(received.toString()) shouldEqual true
//      }
//
//    }
//
//
//  it("should be able to fail to match nested xml bodies with rules") {
//
//    val expected =
//      <ns4:name><foo>bar</foo><aga>joe</aga></ns4:name>
//
//    val received =
//      <ns4:name><foo>bar</foo><aga>1234</aga></ns4:name>
//
//    val rules: Option[Map[String, MatchingRule]] = Option(
//      Map(
//        "$.body.name[0].aga[0]" -> MatchingRule(Option("regex"), Option("\\D+"), None)
...
//
//    withClue("Didn't match json body with rule") {
//      matchBodies(rules)(expected.toString())(received.toString()) shouldEqual false
//    }
//
//  }

  it("should be able to fail to match when not enough xml elements") {

    val expected =
      <name><aga>joe</aga></name>
    ...
    val rules: Option[Map[String, MatchingRule]] = Option(
      Map(
        "$.body.name" -> MatchingRule(Option("min"), None, Option(2))
      )
    )
...
//        </fish-supper>
//
//      withClue("Received xml elements in different orders") {
//        matchBodies(None)(expected5.toString())(received5.toString()) shouldEqual false
//      }
